        ...
        >
          ...
          <div data-reveal className="lg:col-span-7">
            ...
            >
              ...
              <button
                type="submit"
                className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-brand-blue px-6 py-3.5 text-base font-semibold text-white transition-all hover:bg-brand-blue/90 hover:shadow-[0_0_32px_-6px_rgba(59,130,246,0.8)] sm:w-auto"
              >
                {sent ? (
                  <>
              ...
              <p className="mt-3 text-xs text-slate">
                This opens your email client addressed to {CONTACT_EMAIL}. No
